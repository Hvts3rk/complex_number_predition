...
print("mese: " + mese)
print("mese_numero: "+ mese_numero)
print("anno: " + anno)

print("Benvenuto nel General CSV Data Extractor!")
...
extracted_file = "estrazioni/" + anno + "/" + mese_numero + ".csv"
if not os.path.isfile(extracted_file) or debug:
    with open("estrazioni/" + anno + "/" + mese_numero + ".csv", mode="w") as ext_file:
        ...
        with open("raw_data/" + mese_numero + "_" + anno + ".json") as f:
            ...
            for items in data["concorsi"]:
                ...
                print(items['combinazioneVincente']["estratti"])
